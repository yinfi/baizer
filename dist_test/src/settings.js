...
exports.GeminiShellSettingTab = void 0;
const obsidian_1 = require("obsidian");
const types_1 = require("./mcp/types");
class GeminiShellSettingTab extends obsidian_1.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian_1.Setting(containerEl)
            ...
            if (!this.plugin.settings.apiKey) {
                new obsidian_1.Notice('⚠️ Please enter an API key first.');
                return;
            }
            try {
                new obsidian_1.Notice('Testing connection...');
        ...
        new obsidian_1.Setting(containerEl)
            ...
            .onChange(async (value) => {
            if (value)
                new obsidian_1.Notice('⚠️ Permission Granted: AI can now control your plugins.');
        ...
        if (this.plugin.settings.customizePrompt) {
            ...
            new obsidian_1.Setting(containerEl)
                ...
                .onClick(async () => {
                this.plugin.settings.systemPrompt = types_1.DEFAULT_SETTINGS.systemPrompt;
                await this.plugin.saveSettings();
                this.display();
            }));
        }
...
exports.GeminiShellSettingTab = GeminiShellSettingTab;
