...
class MemoryManager {
    constructor(app, model) {
        ...
        this.lastProfileUpdateTime = 0;
        this.MEMORY_DIR = '.obsidian/gemini-memory';
        this.PROFILE_FILE = 'user-profile.json';
        this.SUMMARY_FILE = 'session-summaries.json';
        this.PROFILE_UPDATE_INTERVAL = 20;
        this.PROFILE_UPDATE_MIN_TIME = 10 * 60 * 1000;
